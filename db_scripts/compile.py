...
functions = [
    ...
    './functions/select_person_user.sql',
     ...
     './functions/disable_propietario.sql',
     './functions/disable_guardia.sql',
     './functions/select_propietarios_by_barrio.sql'
]
